...
<div class="figure">
  <img src="figures/chapter6/placeholder_perceptron_axon_dendrite.png" alt="Perceptron and axon–dendrite analogy" />
  <p class="caption"><strong>Figure 6.1.</strong> [Placeholder: Perceptron and axon–dendrite analogy. A single neuron: inputs (dendrites), weights (synapses), linear combination (cell body), and output (axon).]</p>
</div>
...
<div class="figure">
  <img src="figures/chapter6/placeholder_linear_two_stages.png" alt="Two-stage linear model equivalent to one linear map" />
  <p class="caption"><strong>Figure 6.2.</strong> [Placeholder: Two-stage linear model (x → z → y) and the fact that Y = w^T Z = w^T (W X) = (W^T w)^T X is still a single linear map in x.]</p>
</div>
